        ...
        <div>
          {viewType == 'view' ? (
            ...
            <div className='question-card'>
              ...
              <div className='question-block'>
                <h3>
                  Did this organization meet expectations of what they promised?
                </h3>
                <BsFillSquareFill
              ...
              <div className='question-block'>
                ...
                <BsFillSquareFill
                  ...
                  color={trustRating > 0 && trustRating < 6 ? 'green' : 'grey'}
                  className='rating-box'
                />
                <BsFillSquareFill
                  onClick={() => setTrustRating(2)}
                  color={trustRating > 1 && trustRating < 6 ? 'green' : 'grey'}
                  className='rating-box'
                />
                <BsFillSquareFill
                  onClick={() => setTrustRating(3)}
                  color={trustRating > 2 && trustRating < 6 ? 'green' : 'grey'}
                  className='rating-box'
                />
                <BsFillSquareFill
                  onClick={() => setTrustRating(4)}
                  color={trustRating > 3 && trustRating < 6 ? 'green' : 'grey'}
                  className='rating-box'
                />
                <BsFillSquareFill
                  onClick={() => setTrustRating(5)}
                  color={trustRating > 4 && trustRating < 6 ? 'green' : 'grey'}
                  className='rating-box'
                />
              </div>
              <br />
