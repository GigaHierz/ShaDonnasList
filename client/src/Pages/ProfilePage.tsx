...
function ProfilePage ({
  ...
  const [companyIPFS, setCompanyIPFS] = useState(
    'QmUCtmMYriaW5wC9QQxrFsgWUpCLddEVJygeCgAVagdbwL'
  )
        ...
        <div className=''>
          <div className='question-container'>
            {viewType == 'view' ? (
              <div>
                {ratings
                  .filter(r => r.MappedIPFSHash == companyIPFS)
                  .map(function (rating) {
                    var p = {
              ...
              <div>
                <div className='question-block'>
                  <h3 className='question-block-title'>
                    How inclusive was this organization?
                  </h3>
                  <div className='question-block-stars'>
                    <BsFillSquareFill
                      onClick={() => setInclusiveRating(1)}
                      color={
                        inclusiveRating > 0 && inclusiveRating < 6
                          ? 'green'
                          : 'grey'
                      }
                    ...
                    />
                    <BsFillSquareFill
                      onClick={() => setInclusiveRating(2)}
                      color={
                        inclusiveRating > 1 && inclusiveRating < 6
                          ? 'green'
                          : 'grey'
                      }
                      className='rating-box'
                    />
                    <BsFillSquareFill
                      onClick={() => setInclusiveRating(3)}
                      color={
                        inclusiveRating > 2 && inclusiveRating < 6
                          ? 'green'
                          : 'grey'
                      }
                      className='rating-box'
                    />
                    <BsFillSquareFill
                      onClick={() => setInclusiveRating(4)}
                      color={
                        inclusiveRating > 3 && inclusiveRating < 6
                          ? 'green'
                          : 'grey'
                      }
                      className='rating-box'
                    />
                    <BsFillSquareFill
                      onClick={() => setInclusiveRating(5)}
                      color={
                        inclusiveRating > 4 && inclusiveRating < 6
                          ? 'green'
                          : 'grey'
                      }
                      className='rating-box'
                ...
                <div className='question-block'>
                  ...
                  <BsFillSquareFill
                    onClick={() => setExpectationsRating(1)}
                    color={
                      expectationsRating > 0 && expectationsRating < 6
                        ? 'green'
                        : 'grey'
                    }
                    className='rating-box'
                  />
                  <BsFillSquareFill
                    onClick={() => setExpectationsRating(2)}
                    color={
                      expectationsRating > 1 && expectationsRating < 6
                        ? 'green'
                        : 'grey'
                    }
                    className='rating-box'
                  />
                  <BsFillSquareFill
                    onClick={() => setExpectationsRating(3)}
                    color={
                      expectationsRating > 2 && expectationsRating < 6
                        ? 'green'
                        : 'grey'
                    }
                    className='rating-box'
                  />
                  <BsFillSquareFill
                    onClick={() => setExpectationsRating(4)}
                    color={
                      expectationsRating > 3 && expectationsRating < 6
                        ? 'green'
                        : 'grey'
                    }
                    className='rating-box'
                  />
                  <BsFillSquareFill
                    onClick={() => setExpectationsRating(5)}
                    color={
                      expectationsRating > 4 && expectationsRating < 6
                        ? 'green'
                        : 'grey'
                    }
                    className='rating-box'
                ...
                <div className='question-block'>
                  <h3 className='question-block-title'>
                    Do you consider this a trustworthy organization?
                  </h3>
                  <BsFillSquareFill
                    onClick={() => setTrustRating(1)}
                    color={
                      trustRating > 0 && trustRating < 6 ? 'green' : 'grey'
                    }
                    className='rating-box'
                  />
                  <BsFillSquareFill
                    onClick={() => setTrustRating(2)}
                    color={
                      trustRating > 1 && trustRating < 6 ? 'green' : 'grey'
                    }
                    className='rating-box'
                  />
                  <BsFillSquareFill
                    onClick={() => setTrustRating(3)}
                    color={
                      trustRating > 2 && trustRating < 6 ? 'green' : 'grey'
                    }
                    className='rating-box'
                  />
                  <BsFillSquareFill
                    onClick={() => setTrustRating(4)}
                    color={
                      trustRating > 3 && trustRating < 6 ? 'green' : 'grey'
                    }
                    className='rating-box'
                  />
                  <BsFillSquareFill
                    onClick={() => setTrustRating(5)}
                    color={
                      trustRating > 4 && trustRating < 6 ? 'green' : 'grey'
                    }
                    className='rating-box'
                  />
                </div>
